...
export default function Navbar() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (!isFirebaseConfigured) {
      setAuthError('Tính năng Đăng nhập bằng Google yêu cầu cấu hình Firebase. Vui lòng cấu hình file .env!');
      return;
    }
          ...
          <div className="modal-content glass-panel" onClick={(e) => e.stopPropagation()}>
            ...
            {!isFirebaseConfigured && (
              <div className="warning-alert">
                <strong>⚠️ Chế độ Offline:</strong> Firebase chưa được cấu hình. Hệ thống sẽ tự động sử dụng Local Database để đăng nhập/đăng ký. SMS OTP, Đăng nhập Google và Email khôi phục sẽ bị tạm tắt.
              </div>
            )}
            ...
            {authMode === 'login' && (
              <form className="modal-form" onSubmit={handleLoginSubmit}>
                ...
                {isFirebaseConfigured && (
                  <>
                    <div className="auth-divider">hoặc sử dụng</div>
