...
export const coursesData = [
  {
    ...
    artFormula: `<svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="40" stroke="rgba(255,255,255,0.1)" stroke-width="2"/><circle cx="50" cy="50" r="20" stroke="rgba(255,255,255,0.15)" stroke-width="2"/><path d="M 10 50 L 90 50 M 50 10 L 50 90" stroke="rgba(255,255,255,0.1)" stroke-width="2"/></svg>`,
    bannerBg: 'linear-gradient(135deg, #0f172a 0%, #0f4a38 100%)',
    theme: 'dark',
  ...
  },
  {
    ...
    image: '/images/bg.jpg',
    artFormula: `<svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="60" height="60" rx="10" stroke="rgba(0,0,0,0.1)" stroke-width="3"/><rect x="35" y="35" width="30" height="30" rx="5" fill="rgba(0,0,0,0.05)"/></svg>`,
    bannerBg: 'linear-gradient(135deg, #f0fdf4 0%, #bbf7d0 100%)',
    theme: 'light',
  ...
  },
  {
    ...
    artFormula: `<svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="50,10 90,80 10,80" stroke="rgba(0,0,0,0.1)" stroke-width="2"/><polygon points="50,30 75,70 25,70" stroke="rgba(0,0,0,0.05)" stroke-width="2"/></svg>`,
  ...
  },
  {
    ...
    image: '/images/tccvang.jpg',
    artFormula: `<svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M 20 50 Q 50 10 80 50 T 140 50" stroke="rgba(255,255,255,0.15)" stroke-width="3"/><path d="M 0 50 Q 30 90 60 50 T 120 50" stroke="rgba(255,255,255,0.1)" stroke-width="2"/></svg>`,
    bannerBg: 'linear-gradient(135deg, #1e1b4b 0%, #3730a3 100%)',
    theme: 'dark',
