...
export default function CourseDetail() {
  ...
  return (
    <div
      className={`courses-page course-detail-shell ${course.theme === 'light' ? 'light-banner-theme' : ''}`}
    ...
    >
      ...
      <section className="course-detail-hero-banner" style={{ background: course.bannerBg }}>
        {course.artFormula && (
          <div className="course-art-formula" dangerouslySetInnerHTML={{ __html: course.artFormula }} />
        )}
